<x-guest-layout>
     ...
     <div class="container max-w-lg px-4 py-32 mx-auto text-left bg-center bg-no-repeat bg-cover md:max-w-none md:text-center"
        ...
        <h1
            ...
            <span class="inline md:block">Welcome To DeliFood Restaurant</span>
        </h1>
    ...
    <section class="px-2 py-32 bg-white md:px-0">
        <div class="container items-center max-w-6xl px-8 mx-auto xl:px-5">
            ...
            > -->
                        ...
                        Once upon a time, in a bustling city, there was a quaint restaurant named "Savor Haven." The story of this restaurant was woven with passion, perseverance, and the pursuit of culinary excellence. Owned by a talented chef named Mia, Savor Haven started as a humble dream in her heart. With sheer determination and unwavering belief, Mia transformed a small, empty space into a culinary sanctuary where flavors danced on the taste buds of delighted patrons. From the tantalizing aromas that wafted through the air to the carefully curated menu that showcased Mia's culinary artistry, Savor Haven became a haven for food enthusiasts.
                        </p>
    ...
    <section class="pt-4 pb-12 bg-gray-800">
        ...
        <div class="grid gap-2 lg:grid-cols-3">
            <div class="max-w-md p-4 bg-white rounded-lg shadow-lg">
                ...
                <div>
                    <h2 class="text-3xl font-semibold text-gray-800">Delivery</h2>
                    <p class="mt-2 text-gray-600">John played a pivotal role in the efficient and reliable delivery services of the food company. With a keen attention to detail and exceptional organizational skills, he ensured that orders were promptly prepared and dispatched to customers. John's commitment to timely deliveries, combined with his friendly and professional demeanor.</p>
                </div>
            ...
            <div class="max-w-md p-4 bg-white rounded-lg shadow-lg">
                ...
                <div>
                    ...
                    <p class="mt-2 text-gray-600">With unwavering dedication, John provided exceptional service in a renowned food company, impressing customers and colleagues alike with his culinary skills, attentive care, and friendly demeanor. His contributions were instrumental in shaping the company's success and reputation, John contributed significantly to the success and reputation of the food company.</p>
                </div>
                <div class="flex justify-end mt-4">
                    <a href="#" class="text-xl font-medium text-green-500">Alexia Smith</a>
                </div>
            </div>
            <div class="max-w-md p-4 bg-white rounded-lg shadow-lg">
                <div class="flex justify-center -mt-16 md:justify-end">
                ...
                <div>
                    ...
                    <p class="mt-2 text-gray-600">John, with his passion for food, brought his expertise and creativity to the forefront during his time in the food industry. Through culinary mastery and an unwavering commitment to quality, he delighted customers with delectable dishes and innovative flavors. Whether it was meticulously crafting intricate desserts or creating savory masterpieces.</p>
                </div>
                <div class="flex justify-end mt-4">
                    <a href="#" class="text-xl font-medium text-green-500">Jaqueline Fernandez</a>
                </div>
            </div>
        </div>
    </section>
