<x-admin-layout>
  ...
  <form enctype="multipart/form-data" method="post" action="{{route('admin.menus.update',$menu->id)}}" >
    ...
    <div class="sm:col-span-6">
      ...
      <div class="mt-1">
        <input type="text" id="name" value="{{$menu->name}}" name="name" class="block w-full appearance-none bg-white border border-gray-400 rounded-md py-2 px-3 text-base leading-normal sm:text-sm sm:leading-5 @error('name') border-red-400 @enderror" />
      </div>
      @error('name')
